...
public class ThreatConDiagnosis extends Diagnosis
{
    public ThreatConDiagnosis(String assetName, Object initialValue, ServiceBroker serviceBroker) 
	throws IllegalValueException, TechSpecNotFoundException {
	super(assetName, initialValue, serviceBroker);
    }

    public ThreatConDiagnosis(String assetName, ServiceBroker serviceBroker) 
    ...
    /**
     * Returns a verbose pretty-printed representation for a ThreatConDiagnosis.
     */
    public String dump() {
	return "\n" +
            "<ThreatConDiagnosis:\n" +
