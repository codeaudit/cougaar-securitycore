...
INSERT INTO asb_agent (ASSEMBLY_ID, COMPONENT_ALIB_ID, COMPONENT_LIB_ID, CLONE_SET_ID, COMPONENT_NAME) VALUES ('RCP-0005-IHMCPolicyDomainManagerServletAgent','IHMCPolicyDomainServletAgent','IHMCPolicyDomainServletAgent',0.000000000000000000000000000000,'IHMCPolicyDomainServletAgent');
UNLOCK TABLES;
...
INSERT INTO asb_agent_pg_attr (ASSEMBLY_ID, COMPONENT_ALIB_ID, PG_ATTRIBUTE_LIB_ID, ATTRIBUTE_VALUE, ATTRIBUTE_ORDER, START_DATE, END_DATE) VALUES ('RCP-0005-IHMCPolicyDomainManagerServletAgent','IHMCPolicyDomainServletAgent','ClusterPG|ClusterIdentifier','IHMCPolicyDomainManagerServletAgent',0.000000000000000000000000000000,'2000-01-01 00:00:00',NULL);
INSERT INTO asb_agent_pg_attr (ASSEMBLY_ID, COMPONENT_ALIB_ID, PG_ATTRIBUTE_LIB_ID, ATTRIBUTE_VALUE, ATTRIBUTE_ORDER, START_DATE, END_DATE) VALUES ('RCP-0005-IHMCPolicyDomainManagerServletAgent','IHMCPolicyDomainServletAgent','ItemIdentificationPG|AlternateItemIdentification','IHMCPolicyDomainManagerServletAgent',0.000000000000000000000000000000,'2000-01-01 00:00:00',NULL);
INSERT INTO asb_agent_pg_attr (ASSEMBLY_ID, COMPONENT_ALIB_ID, PG_ATTRIBUTE_LIB_ID, ATTRIBUTE_VALUE, ATTRIBUTE_ORDER, START_DATE, END_DATE) VALUES ('RCP-0005-IHMCPolicyDomainManagerServletAgent','IHMCPolicyDomainServletAgent','ItemIdentificationPG|ItemIdentification','IHMCPolicyDomainManagerServletAgent',0.000000000000000000000000000000,'2000-01-01 00:00:00',NULL);
INSERT INTO asb_agent_pg_attr (ASSEMBLY_ID, COMPONENT_ALIB_ID, PG_ATTRIBUTE_LIB_ID, ATTRIBUTE_VALUE, ATTRIBUTE_ORDER, START_DATE, END_DATE) VALUES ('RCP-0005-IHMCPolicyDomainManagerServletAgent','IHMCPolicyDomainServletAgent','ItemIdentificationPG|Nomenclature','UTC/RTOrg',0.000000000000000000000000000000,'2000-01-01 00:00:00',NULL);
INSERT INTO asb_agent_pg_attr (ASSEMBLY_ID, COMPONENT_ALIB_ID, PG_ATTRIBUTE_LIB_ID, ATTRIBUTE_VALUE, ATTRIBUTE_ORDER, START_DATE, END_DATE) VALUES ('RCP-0005-IHMCPolicyDomainManagerServletAgent','IHMCPolicyDomainServletAgent','TypeIdentificationPG|TypeIdentification','UTC/RTOrg',0.000000000000000000000000000000,'2000-01-01 00:00:00',NULL);
UNLOCK TABLES;
...
INSERT INTO asb_assembly (ASSEMBLY_ID, ASSEMBLY_TYPE, DESCRIPTION) VALUES ('RCP-0005-IHMCPolicyDomainManagerServletAgent','RCP','IHMCPolicyDomainManagerServletAgent-cpy');
UNLOCK TABLES;
