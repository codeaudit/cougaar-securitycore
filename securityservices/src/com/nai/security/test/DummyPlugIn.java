...
public class DummyPlugIn {
  public void DummyPlugIn() {
    System.out.println("DummyPlugIn. Dummy PlugIn Constructor");
    printPrincipals();
  }

  public void run() {
    System.out.println("DummyPlugIn. Dummy PlugIn run. Calling printPrincipals()");
    printPrincipals();
  ...
  public void printPrincipals() {
    ...
    System.out.println("  DummyPlugIn. printPrincipals():");
    if (subj != null) {
