...
MYPROPERTIES="-Dorg.cougaar.system.path=$COUGAAR_INSTALL_PATH/sys -Dorg.cougaar.install.path=$COUGAAR_INSTALL_PATH -Dorg.cougaar.core.servlet.enable=true -Dorg.cougaar.lib.web.scanRange=100 -Dorg.cougaar.lib.web.http.port=8893 -Dorg.cougaar.lib.web.https.port=-1 -Dorg.cougaar.lib.web.https.clientAuth=true -Dorg.cougaar.core.logging.config.filename=logging.props -Xbootclasspath/p:$COUGAAR_INSTALL_PATH/lib/javaiopatch.jar"

MYMEMORY="-Xmx200m -Xss1024k -Xms100m"
