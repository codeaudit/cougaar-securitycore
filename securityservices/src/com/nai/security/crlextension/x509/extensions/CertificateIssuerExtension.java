...
package com.nai.security.crlextension.x509.extensions;
  ...
  implements CertAttrSet
{
    ...
    throws IOException
  {
	...
	issuerName = new GeneralNames(dervalue);
      }
    catch(GeneralNamesException generalnamesexception)
      {
  ...
  private GeneralNames issuerName=null; 
