...
final public class UltralogActionConcepts
{
    ...
    public static final String DrrsAction = OntologyLanguageTagSelector.selectLanguageForTag(UltralogActionOwlURL + "DrrsAction");
    ...
    public static String DrrsAction() { return DrrsAction; };
    ...
    public static final String drrsHasPrivilege = OntologyLanguageTagSelector.selectLanguageForTag(UltralogActionOwlURL + "drrsHasPrivilege");
    ...
    public static final String drrsHasDataField = OntologyLanguageTagSelector.selectLanguageForTag(UltralogActionOwlURL + "drrsHasDataField");
    public static final String drrsHasDataSource = OntologyLanguageTagSelector.selectLanguageForTag(UltralogActionOwlURL + "drrsHasDataSource");
    ...
    public static String drrsHasPrivilege() { return drrsHasPrivilege; };
    ...
    public static String drrsHasDataField() { return drrsHasDataField; };
    public static String drrsHasDataSource() { return drrsHasDataSource; };
