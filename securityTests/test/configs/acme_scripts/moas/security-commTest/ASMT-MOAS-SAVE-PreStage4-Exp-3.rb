...
name: ASMT-MOAS-II-Save-Pre-Stage4-Exp-3
group: Save
...
#    - $CIP/csmart/config/rules/security/ruleset/signConfig
    ...
    - $CIP/csmart/lib/security/rules/test_comm/util_off.rule
    - $CIP/csmart/lib/security/rules/test_comm/user_off.rule
    - $CIP/csmart/lib/security/rules/test_comm/mnr_off.rule
    - $CIP/csmart/lib/security/rules/test_comm/dp_off.rule
    - $CIP/csmart/lib/security/rules/test_comm/crl_off.rule
