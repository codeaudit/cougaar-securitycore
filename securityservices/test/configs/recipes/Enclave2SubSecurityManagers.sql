...
--- ENCLAVE2 SUB1 SECURITY MANAGER
...
REPLACE INTO lib_mod_recipe (MOD_RECIPE_LIB_ID, NAME, JAVA_CLASS, DESCRIPTION) VALUES ('RECIPE-0001Enclave2SubSecurityManagers','Enclave2SubSecurityManagers','org.cougaar.tools.csmart.recipe.CompleteAgentRecipe','No description available');
UNLOCK TABLES;
...
REPLACE INTO lib_mod_recipe_arg (MOD_RECIPE_LIB_ID, ARG_NAME, ARG_ORDER, ARG_VALUE) VALUES ('RECIPE-0001Enclave2SubSecurityManagers','Assembly Id',0.000000000000000000000000000000,'RCP-0001-Enclave2SubSecurityManagers');
UNLOCK TABLES;
...
--- ENCLAVE2 SUB2 SECURITY MANAGER
...
REPLACE INTO asb_component_hierarchy (ASSEMBLY_ID, COMPONENT_ALIB_ID, PARENT_COMPONENT_ALIB_ID, PRIORITY, INSERTION_ORDER) VALUES ('RCP-0001-Enclave2SubSecurityManagers','Enclave2Sub2Manager','Enclave2SubSecurityManagers','COMPONENT',0.000000000000000000000000000000);
