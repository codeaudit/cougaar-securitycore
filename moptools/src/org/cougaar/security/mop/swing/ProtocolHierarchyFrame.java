...
package org.cougaar.security.mop.swing;
...
import org.cougaar.security.mop.ethereal.ProtocolStatistics;
import org.cougaar.security.mop.ethereal.ProtocolStatisticsTreeModel;
import org.cougaar.security.mop.ethereal.GlobalStatistics;
import org.cougaar.security.mop.swing.JTreeTable;
  ...
  extends JFrame
{
  ...
  public ProtocolHierarchyFrame(TreeNode top) {
    ...
    final JTreeTable tree =
      new JTreeTable(new ProtocolStatisticsTreeModel(_top));
    ...
    */
    ...
    Dimension minimumSize = new Dimension(800, 120);
  ...
  public void displayGlobalStatistics(GlobalStatistics gs) {
    _detailPane.setContentType("text/html");
    _detailPane.setText(gs.toHtml());
  }
