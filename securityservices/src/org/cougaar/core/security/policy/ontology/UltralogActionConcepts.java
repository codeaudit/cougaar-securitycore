...
final public class UltralogActionConcepts
{
	...
	// Concepts
    public static final String EditKbsEntryAction = OntologyLanguageTagSelector.selectLanguageForTag(UltralogActionOwlURL + "EditKbsEntryAction");
    ...
    public static String EditKbsEntryAction() { return EditKbsEntryAction; };
	...
	// Properties
    public static final String editKbsEntryActionType = OntologyLanguageTagSelector.selectLanguageForTag(UltralogActionOwlURL + "editKbsEntryActionType");
    ...
    public static final String editKbsEntryActionTargetPropertyType = OntologyLanguageTagSelector.selectLanguageForTag(UltralogActionOwlURL + "editKbsEntryActionTargetPropertyType");
    ...
    public static final String editKbsEntryActionRequestorUserRealm = OntologyLanguageTagSelector.selectLanguageForTag(UltralogActionOwlURL + "editKbsEntryActionRequestorUserRealm");
    ...
    public static String editKbsEntryActionType() { return editKbsEntryActionType; };
    ...
    public static String editKbsEntryActionTargetPropertyType() { return editKbsEntryActionTargetPropertyType; };
    ...
    public static String editKbsEntryActionRequestorUserRealm() { return editKbsEntryActionRequestorUserRealm; };
