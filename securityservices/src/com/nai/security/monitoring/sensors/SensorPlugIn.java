...
String [] nodename=null;
        ...
        if(MonitoringUtils.debug>0)
	{
		System.out.println("In exec of Sensor");
          ...
          {
        	if(MonitoringUtils.debug>0)
              		System.out.println("in publishing capabilities");
	...
	if(self==null)
           {
        	if(MonitoringUtils.debug>0)
               		System.out.println("Self was null");
               self=findself();
		if(self!=null)
		{
               		if(  Services.isEmpty())
           ...
           if(self!=null)
           {
        	if(MonitoringUtils.debug>0)
		{
               		System.out.println("Creating send cap obj:%%%%%%%%%%%%%%%%%%%%%%%%%"+publishedcapabilities);
               		DumpVector(   Services);
    ...
    */
                		...
                		if(fi.length>0)
				{
					for(int z=0;z<fi.length;z++)
					{
						...
						if(!data.isEmpty())
						{
								...
								if(MonitoringUtils.debug>0)
									System.out.println("***** publishing security excep::****************************");
						...
						{
							if(MonitoringUtils.debug>0)
								System.out.println(" got data vector for publishing security empty ********************************");
						}
					}
				}
              		}
    ...
    {
        System.out.println("Services got through ini.dat is :");
    ...
    protected void process_publishCmd(Enumeration publichcmdlist)
    {
		...
		if(MonitoringUtils.debug>0)	
                	 System.out.println("Add ::::::::"+pcmd.Type+" to current publishing list");
              }
