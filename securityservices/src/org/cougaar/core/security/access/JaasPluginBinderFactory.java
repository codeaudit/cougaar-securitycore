 ...
 * Node.AgentManager.Binder = org.cougaar.core.security.access.JaasPluginBinderFactory
 *
 */
public class JaasPluginBinderFactory
  extends BinderFactorySupport
  implements BinderFactoryWrapper
{
    /** Creates new JaasPluginBinderFactory */
    public JaasPluginBinderFactory() {
    }
    
    protected Class getBinderClass(Object child) {
      return JaasPluginBinder.class;
    }
