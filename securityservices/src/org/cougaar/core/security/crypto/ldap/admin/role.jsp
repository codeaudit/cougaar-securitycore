...
function newRole() {
  top.frames['UserMatchFrame'].location.href='<%=request.getRequestURI() + "?" + UserInterface.PAGE + "=" + UserInterface.PAGE_NEW_ROLE_JSP%>';
}
</script>
  </head>
  ...
  <body>
    <table width="100%">
      <tr>
        <td align="right"><a href="<%=request.getRequestURI() + "?" +
                      UserInterface.PAGE + "=" +
                      UserInterface.PAGE_SEARCH_USER%>">Users</a></td>
        <td align="center">|</td>
    ...
    <form action="<%=request.getRequestURI()%>"
      ...
      <input type="hidden" name="<%=UserInterface.PAGE%>" 
             value="<%=UserInterface.PAGE_RESULTS_ROLE%>">
      <table width="100%">
        <tr>
          <td>Search Term</td>
