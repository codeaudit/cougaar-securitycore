...
final public class UltralogActionConcepts
{
    ...
    public static final String EditUserAction = OntologyLanguageTagSelector.selectLanguageForTag(UltralogActionOwlURL + "EditUserAction");
    ...
    public static final String OQLAction = OntologyLanguageTagSelector.selectLanguageForTag(UltralogActionOwlURL + "OQLAction");
    ...
    public static String EditUserAction() { return EditUserAction; };
    public static String CommunityAction() { return CommunityAction; };
    public static String OQLAction() { return OQLAction; };
	...
	// Properties
    public static final String editUserActionTargetObjectType = OntologyLanguageTagSelector.selectLanguageForTag(UltralogActionOwlURL + "editUserActionTargetObjectType");
    public static final String editUserActionType = OntologyLanguageTagSelector.selectLanguageForTag(UltralogActionOwlURL + "editUserActionType");
    ...
    public static final String oqlHasDataSource = OntologyLanguageTagSelector.selectLanguageForTag(UltralogActionOwlURL + "oqlHasDataSource");
    ...
    public static final String oqlHasDataField = OntologyLanguageTagSelector.selectLanguageForTag(UltralogActionOwlURL + "oqlHasDataField");
    public static final String editUserActionTargetUserRealm = OntologyLanguageTagSelector.selectLanguageForTag(UltralogActionOwlURL + "editUserActionTargetUserRealm");
    public static final String oqlHasPrivilege = OntologyLanguageTagSelector.selectLanguageForTag(UltralogActionOwlURL + "oqlHasPrivilege");
    ...
    public static final String editUserActionTargetPropertyType = OntologyLanguageTagSelector.selectLanguageForTag(UltralogActionOwlURL + "editUserActionTargetPropertyType");

    public static String editUserActionTargetObjectType() { return editUserActionTargetObjectType; };
    ...
    public static String oqlHasDataSource() { return oqlHasDataSource; };
    public static String blackBoardAccessMode() { return blackBoardAccessMode; };
    public static String community() { return community; };
    public static String oqlHasDataField() { return oqlHasDataField; };
    public static String editUserActionTargetUserRealm() { return editUserActionTargetUserRealm; };
    public static String oqlHasPrivilege() { return oqlHasPrivilege; };
    ...
    public static String editUserActionTargetPropertyType() { return editUserActionTargetPropertyType; };
