...
name: ASMT-MOAS-II-Save-Pre-Stage4-Sub-Exp4.1
group: Save
...
#    - $CIP/csmart/config/rules/security/ruleset/signConfig
    ...
    - $CIP/csmart/lib/security/rules/test_comm/util_respoff.rule
    - $CIP/csmart/lib/security/rules/test_comm/user_respoff.rule
    - $CIP/csmart/lib/security/rules/test_comm/mnr_respoff.rule
    - $CIP/csmart/lib/security/rules/test_comm/dp_respoff.rule
    - $CIP/csmart/lib/security/rules/test_comm/crl_respoff.rule
