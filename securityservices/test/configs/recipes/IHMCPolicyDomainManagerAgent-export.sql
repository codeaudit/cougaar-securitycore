...
INSERT INTO asb_agent (ASSEMBLY_ID, COMPONENT_ALIB_ID, COMPONENT_LIB_ID, CLONE_SET_ID, COMPONENT_NAME) VALUES ('RCP-0004-IHMCPolicyDomainManagerAgent','IHMCPolicyDomainManagerAgent-cpy','IHMCPolicyDomainManagerAgent',0.000000000000000000000000000000,'IHMCPolicyDomainManagerAgent');
UNLOCK TABLES;
...
INSERT INTO asb_agent_pg_attr (ASSEMBLY_ID, COMPONENT_ALIB_ID, PG_ATTRIBUTE_LIB_ID, ATTRIBUTE_VALUE, ATTRIBUTE_ORDER, START_DATE, END_DATE) VALUES ('RCP-0004-IHMCPolicyDomainManagerAgent','IHMCPolicyDomainManagerAgent-cpy','ClusterPG|ClusterIdentifier','IHMCPolicyDomainManagerAgent',0.000000000000000000000000000000,'2000-01-01 00:00:00',NULL);
...
INSERT INTO asb_assembly (ASSEMBLY_ID, ASSEMBLY_TYPE, DESCRIPTION) VALUES ('RCP-0004-IHMCPolicyDomainManagerAgent','RCP','IHMCPolicyDomainManagerAgent-cpy');
UNLOCK TABLES;
...
INSERT INTO asb_component_arg (ASSEMBLY_ID, COMPONENT_ALIB_ID, ARGUMENT, ARGUMENT_ORDER) VALUES ('RCP-0004-IHMCPolicyDomainManagerAgent','IHMCPolicyDomainManagerAgent-cpy','IHMCPolicyDomainManagerAgent',1.000000000000000000000000000000);
INSERT INTO asb_component_arg (ASSEMBLY_ID, COMPONENT_ALIB_ID, ARGUMENT, ARGUMENT_ORDER) VALUES ('RCP-0004-IHMCPolicyDomainManagerAgent','IHMCPolicyDomainManagerAgent|safe.policyManager.DomainManagerPlugin','IHMCPolicyDomainManagerDomain',1.000000000000000000000000000000);
UNLOCK TABLES;
...
INSERT INTO asb_component_hierarchy (ASSEMBLY_ID, COMPONENT_ALIB_ID, PARENT_COMPONENT_ALIB_ID, PRIORITY, INSERTION_ORDER) VALUES ('RCP-0004-IHMCPolicyDomainManagerAgent','IHMCPolicyDomainManagerAgent-cpy','IHMCPolicyDomainManagerAgent-cpy','COMPONENT',0.000000000000000000000000000000);
