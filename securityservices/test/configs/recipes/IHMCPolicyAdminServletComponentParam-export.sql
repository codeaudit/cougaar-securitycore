...
REPLACE INTO alib_component (COMPONENT_ALIB_ID, COMPONENT_NAME, COMPONENT_LIB_ID, COMPONENT_TYPE, CLONE_SET_ID) VALUES ('PolicyAdminServletComponentParam|safe.policyManager.PolicyAdminServletComponent|Enclave1Security-COMM','PolicyAdminServletComponentParam|safe.policyManager.PolicyAdminServletComponent|Enclave1Security-COMM','plugin|safe.policyManager.PolicyAdminServletComponent','plugin',0.000000000000000000000000000000);
REPLACE INTO alib_component (COMPONENT_ALIB_ID, COMPONENT_NAME, COMPONENT_LIB_ID, COMPONENT_TYPE, CLONE_SET_ID) VALUES ('PolicyAdminServletComponentParam|safe.policyManager.PolicyAdminServletComponent|Enclave2Security-COMM','PolicyAdminServletComponentParam|safe.policyManager.PolicyAdminServletComponent|Enclave2Security-COMM','plugin|safe.policyManager.PolicyAdminServletComponent','plugin',0.000000000000000000000000000000);
REPLACE INTO alib_component (COMPONENT_ALIB_ID, COMPONENT_NAME, COMPONENT_LIB_ID, COMPONENT_TYPE, CLONE_SET_ID) VALUES ('PolicyAdminServletComponentParam|safe.policyManager.PolicyAdminServletComponent|Enclave3Security-COMM','PolicyAdminServletComponentParam|safe.policyManager.PolicyAdminServletComponent|Enclave3Security-COMM','plugin|safe.policyManager.PolicyAdminServletComponent','plugin',0.000000000000000000000000000000);
REPLACE INTO alib_component (COMPONENT_ALIB_ID, COMPONENT_NAME, COMPONENT_LIB_ID, COMPONENT_TYPE, CLONE_SET_ID) VALUES ('PolicyAdminServletComponentParam|safe.policyManager.PolicyAdminServletComponent|Enclave4Security-COMM','PolicyAdminServletComponentParam|safe.policyManager.PolicyAdminServletComponent|Enclave4Security-COMM','plugin|safe.policyManager.PolicyAdminServletComponent','plugin',0.000000000000000000000000000000);
UNLOCK TABLES;
...
REPLACE INTO lib_component (COMPONENT_LIB_ID, COMPONENT_TYPE, COMPONENT_CLASS, INSERTION_POINT, DESCRIPTION) VALUES ('plugin|safe.policyManager.PolicyAdminServletComponent','plugin','safe.policyManager.PolicyAdminServletComponent','plugin','Added plugin');
UNLOCK TABLES;
