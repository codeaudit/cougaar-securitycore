...
REPLACE INTO lib_mod_recipe_arg (MOD_RECIPE_LIB_ID, ARG_NAME, ARG_ORDER, ARG_VALUE) VALUES ('RECIPE-0008Enclave1CAConfigComponentEnclave1CAConfigComponent','Class Name',7.000000000000000000000000000000,'org.cougaar.core.security.certauthority.ConfigPlugin');
REPLACE INTO lib_mod_recipe_arg (MOD_RECIPE_LIB_ID, ARG_NAME, ARG_ORDER, ARG_VALUE) VALUES ('RECIPE-0008Enclave1CAConfigComponentEnclave1CAConfigComponent','Component Name',2.000000000000000000000000000000,'org.cougaar.core.security.certauthority.ConfigPlugin');
REPLACE INTO lib_mod_recipe_arg (MOD_RECIPE_LIB_ID, ARG_NAME, ARG_ORDER, ARG_VALUE) VALUES ('RECIPE-0008Enclave1CAConfigComponentEnclave1CAConfigComponent','Component Priority',1.000000000000000000000000000000,'HIGH');
REPLACE INTO lib_mod_recipe_arg (MOD_RECIPE_LIB_ID, ARG_NAME, ARG_ORDER, ARG_VALUE) VALUES ('RECIPE-0008Enclave1CAConfigComponentEnclave1CAConfigComponent','Number of Arguments',4.000000000000000000000000000000,'3');
...
REPLACE INTO lib_mod_recipe_arg (MOD_RECIPE_LIB_ID, ARG_NAME, ARG_ORDER, ARG_VALUE) VALUES ('RECIPE-0008Enclave1CAConfigComponent','Number of Arguments',4.000000000000000000000000000000,'3');
REPLACE INTO lib_mod_recipe_arg (MOD_RECIPE_LIB_ID, ARG_NAME, ARG_ORDER, ARG_VALUE) VALUES ('RECIPE-0008Enclave1CAConfigComponent','Target Component Selection Query',3.000000000000000000000000000000,'recipeQueryNodeEnclave1CA');
...
REPLACE INTO lib_mod_recipe_arg (MOD_RECIPE_LIB_ID, ARG_NAME, ARG_ORDER, ARG_VALUE) VALUES ('RECIPE-0008Enclave1CAConfigComponent','Value 3',6.000000000000000000000000000000,'cypress:RootCA');
...
REPLACE INTO lib_mod_recipe_arg (MOD_RECIPE_LIB_ID, ARG_NAME, ARG_ORDER, ARG_VALUE) VALUES ('RECIPE-0008Enclave1CAConfigComponentEnclave1CAConfigComponentEnclave1CAConfigComponent','Value 3',6.000000000000000000000000000000,'cypress:RootCA');
UNLOCK TABLES;
