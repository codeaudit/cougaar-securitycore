...
public class MonitoringManager extends SimplePlugIn
{
   ...
   * @see  com.nai.security.monitoring.Util.SendCapabilitiesObj
   */
  ...
  private void process_findingsensor(Enumeration findinglist)
  {
      ...
      for(;findinglist.hasMoreElements();)
      {
          Task tsk=(Task) findinglist.nextElement();
       		if(MonitoringUtils.debug>0)
          	System.out.println("got find sensor task :"+tsk.toString());
    ...
    * @see com.nai.security.monitoring.Util.QueryTaskObj
    */
    ...
    * 
    * @param queryobj QueryTaskObj
    * @see com.nai.security.monitoring.Util.SendManagerCapabilitiesObj
    */
  ...
  void dump (Vector vec)
  {
      for(int i=0;i<vec.size();i++)
      {
          ...
          System.out.println("orgat found is :"+og.toString()+"at  ::"+i);
      }
  }
